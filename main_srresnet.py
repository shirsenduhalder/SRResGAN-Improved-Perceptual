...
parser.add_argument("--adversarial_loss_coefficient", type=float, default=0.001, help="Coefficient for adversarial loss")
parser.add_argument("--vgg_loss_coefficient", type=float, default=0.006, help="Coefficient for VGG loss")
#changed
...
parser.add_argument("--dis_perceptual_loss_coefficient", type=float, default=0.001, help="Coefficient for perceptual loss from discriminator")
